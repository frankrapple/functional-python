# Functional Python [![](https://github.com/frankrapple/functional-python/workflows/tests/badge.svg)](https://github.com/frankrapple/functional-python/actions?query=workflow%3Atests)
